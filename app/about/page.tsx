          ...
          <section className="relative bg-linear-to-br from-blue-600 via-blue-700 to-indigo-800 text-white overflow-hidden">
            ...
            <div className="relative container mx-auto px-4 py-24 lg:py-32">
              <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-2xl lg:text-3xl font-light mb-8 text-blue-100">
                  {aboutContent.hero.subtitle}
                </p>
                <p className="text-lg lg:text-xl text-blue-50 mb-12 max-w-3xl mx-auto leading-relaxed">
            ...
            <div className="container mx-auto px-4">
              <div className="max-w-6xl mx-auto">
                <div className="text-center mb-16">
                  ...
                  <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                    A look at the key milestones that have shaped our journey
                    and defined our growth.
                  </p>
                  <div className="w-24 h-1 bg-blue-600 mx-auto mt-6"></div>
                </div>
                ...
                <div className="relative">
                  ...
                  <div className="space-y-12">
                    {aboutContent.timeline.milestones.map(
                      (milestone, index) => (
                        <div
                          key={index}
